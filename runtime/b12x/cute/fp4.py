...
def packed_dequant_trellis3_to_half2x4(win_a, win_b, *, loc=None, ip=None):
    """8 trellis windows -> 4 fp16x2 fragments (bit-exact to exl3 decode_3inst_2<1>).
    ...
    with w7=win_a, w6=win_a>>3, w5=win_a>>6, w4=win_a>>9,
         w3=win_b, w2=win_b>>3, w1=win_b>>6, w0=win_b>>9  (align==4 >>3 chaining).
    """
    result = llvm.inline_asm(
        llvm.StructType.get_literal([T.i32(), T.i32(), T.i32(), T.i32()]),
        ...
        """
        {
            ...
            and.b32 w7, $4, 0xffff;
            shr.u32 w6, $4, 3;  and.b32 w6, w6, 0xffff;
            shr.u32 w5, $4, 6;  and.b32 w5, w5, 0xffff;
            shr.u32 w4, $4, 9;  and.b32 w4, w4, 0xffff;
            and.b32 w3, $5, 0xffff;
            shr.u32 w2, $5, 3;  and.b32 w2, w2, 0xffff;
            shr.u32 w1, $5, 6;  and.b32 w1, w1, 0xffff;
            shr.u32 w0, $5, 9;  and.b32 w0, w0, 0xffff;
...
def packed_dequant_trellis3_to_bfloat2x4(win_a, win_b, *, loc=None, ip=None):
    """As half2x4 but returns 4 bf16x2 (matches nf3 primitive output type).
    NOTE: prefer the half2x4 primitive + fp16 MMA arm for bit-exactness AND to
    save the 16 cvt ops/frag that stress the 255-reg/zero-spill envelope."""
    h0, h1, h2, h3 = packed_dequant_trellis3_to_half2x4(win_a, win_b, loc=loc, ip=ip)
